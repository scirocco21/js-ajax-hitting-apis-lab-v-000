...
function showRepositories(event, data) {
  ...
  const repoList = `<ul>${repos.map(r => '<li>' + '<a href="' + r.html_url + '">' + r.name + ' - <a href="#" data-repo="' + r.name + '" onclick="getCommits(this)">Get Commits</a>' + '<br>' + '<a href="#" data-repo="' + r.name + '" data-user="' + usernme.value + '" onclick="getBranches(this)">Get Branches</a>' +'</li>').join('')}</ul>`;
